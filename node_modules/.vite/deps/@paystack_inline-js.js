...
function o(n2, e2, t2) {
  return e2 && i(n2.prototype, e2), t2 && i(n2, t2), Object.defineProperty(n2, "prototype", { writable: false }), n2;
}
function r(n2, e2, t2) {
...
function c(n2, e2) {
  ...
  var t2, a2, i2 = function(n3, e3) {
    if (null == n3) return {};
    var t3, a3, i3 = {}, o3 = Object.keys(n3);
    for (a3 = 0; a3 < o3.length; a3++) t3 = o3[a3], e3.indexOf(t3) >= 0 || (i3[t3] = n3[t3]);
    return i3;
  }(n2, e2);
  if (Object.getOwnPropertySymbols) {
    var o2 = Object.getOwnPropertySymbols(n2);
    for (a2 = 0; a2 < o2.length; a2++) t2 = o2[a2], e2.indexOf(t2) >= 0 || Object.prototype.propertyIsEnumerable.call(n2, t2) && (i2[t2] = n2[t2]);
  }
  return i2;
}
function s(n2, e2) {
  return function(n3) {
    ...
    if (null == t2) return;
    var a2, i2, o2 = [], r2 = true, c2 = false;
    try {
      for (t2 = t2.call(n3); !(r2 = (a2 = t2.next()).done) && (o2.push(a2.value), !e3 || o2.length !== e3); r2 = true) ;
    } catch (n4) {
      c2 = true, i2 = n4;
    } finally {
      try {
...
function y(n2, e2) {
  ...
  return Object.keys(n2).forEach(function(i2) {
    var o2 = e2 ? "".concat(e2, "[").concat(i2, "]") : i2, r2 = n2[o2];
    a2.push(null !== r2 && "object" === ("undefined" == typeof v ? "undefined" : t(v)) ? y(r2, o2) : "".concat(encodeURIComponent(i2), "=").concat(encodeURIComponent(r2)));
  }), a2.join("&");
}
function f() {
...
function O(n2, e2, a2) {
  var i2 = e2.channels, o2 = void 0 === i2 ? [] : i2, r2 = e2.styles, c2 = void 0 === r2 ? {} : r2, s2 = { applePay: false };
  return new Promise(function(e3, i3) {
    if (n2) if (T(o2)) {
      ...
      (function(n3, e4) {
        return new Promise(function(t2, a3) {
          ...
          i4.src = n3, i4.addEventListener("load", function() {
            t2(true);
          }), i4.addEventListener("error", function() {
            i4.remove(), a3(false);
          }), e4 ? e4.appendChild(i4) : document.head.appendChild(i4);
        });
        ...
        !function(n3, e4) {
          var t2 = e4.styles, a3 = e4.theme, i4 = document.createElement("style"), o3 = function(n4) {
            var e5 = n4.height, t3 = n4.width, a4 = n4.borderRadius, i5 = n4.padding;
            return "\n  apple-pay-button {\n    --apple-pay-button-width: ".concat(t3, ";\n    --apple-pay-button-height: ").concat(e5, ";\n    --apple-pay-button-border-radius: ").concat(a4, ";\n    --apple-pay-button-padding: ").concat(i5, ";\n    --apple-pay-button-box-sizing: border-box;\n    width: ").concat(t3, ";\n  }\n");
          }(t2);
          i4.type = "text/css", i4.styleSheet ? i4.styleSheet.cssText = o3 : i4.appendChild(document.createTextNode(o3)), n3.appendChild(i4);
    ...
    } else i3("No wallet payment method is available on this device");
    else i3("Container to mount elements was not provided");
  });
}
function j(n2) {
...
var $ = function() {
  var n2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e2 = n2.platform, t2 = n2.userAgent, a2 = void 0 === t2 ? window && window.navigator && window.navigator.userAgent : t2, i2 = e2 || X;
  return Y.includes(i2) || a2.includes("Mac") && "ontouchend" in document;
};
var nn = function(n2, e2, t2) {
  var a2 = "".concat(m.paystackApiUrl, "transaction/update_log/").concat(n2), i2 = { Authorization: "Bearer ".concat(e2) };
...
var tn = { initializeLog: function(n2) {
  ...
  this.log = { start_time: Math.round(Date.now() / 1e3), time_spent: 0, attempts: t2 || 0, authentication: a2, errors: i2 || 0, success: false, mobile: $(), input: [], history: o2 || [] };
...
var on = { requestInline: function() {
  var n2 = this, t2 = this.urlParameters, a2 = t2.language, i2 = t2.connect_account, o2 = c(t2, an), r2 = e({ "Content-Type": "application/json" }, a2 && { "Accept-Language": a2 });
  return (this.accessCode ? fetch(new URL("transaction/verify_access_code/".concat(this.accessCode), m.paystackApiUrl).toString(), { headers: r2 }) : fetch(new URL("/checkout/request_inline", m.paystackApiUrl).toString(), { method: "POST", body: JSON.stringify(o2), headers: e(e({}, r2), i2 && { "x-connect-account": i2 }) })).then(function(n3) {
    return n3.json();
  }).then(function(e2) {
  ...
  function n2(e2) {
    a(this, n2), function(n3) {
      ...
      if (Q.filter(function(n4) {
        ...
        e4 && !t2 && o3.push({ message: "Required parameter missing: ".concat(n4.value) });
      }), i3.forEach(function(n4) {
        var e4 = a2[n4], i4 = Q.find(function(e5) {
          return e5.value === n4;
        }), r3 = t(e4);
        "object" === r3 && Array.isArray(e4) && (r3 = "array"), i4.types.indexOf(r3) <= -1 && o3.push({ message: "Invalid parameter type: ".concat(n4), validTypes: i4.types });
      }), i3.forEach(function(n4) {
        var e4 = Q.find(function(e5) {
          return e5.value === n4;
        });
        e4.override && delete a2[e4.override];
      }), o3.length) throw new e3("Invalid transaction parameters", o3);
    ...
    var i2 = e2.onError, o2 = e2.onLoad, r2 = e2.onSuccess, c2 = e2.onCancel, s2 = e2.callback, l2 = e2.onClose, p2 = e2.onBankTransferConfirmationPending;
    this.callbacks = { onError: i2, onLoad: o2, onSuccess: r2, onCancel: c2, onBankTransferConfirmationPending: p2 }, this.deprecatedCallbacks = { callback: s2, onClose: l2 }, Object.assign(this, on);
  }
  return o(n2, [{ key: "onSetupError", value: function(n3) {
...
var ln;
var pn = ["preload", "inlineTransaction", "transactionData"];
...
var kn = function() {
  function n2(e2) {
    ...
    }(this.id), this.checkoutIframe = (t2 = this.id, (i2 = H("inline-checkout-".concat(t2))).src = "".concat(m.checkoutUrl, "popup"), i2.style.cssText = "\n  z-index: 999999999999999;\n  background: transparent;\n  border: 0px none transparent;\n  overflow-x: hidden;\n  overflow-y: hidden;\n  margin: 0;\n  padding: 0;\n  -webkit-tap-highlight-color: transparent;\n  -webkit-touch-callout: none;\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 100%;\n  visibility: hidden;\n  display: none;\n  height: 100%;\n", i2.setAttribute("allowpaymentrequest", "true"), i2.setAttribute("allow", "payment; clipboard-read; clipboard-write"), document.body.appendChild(i2), i2), this.registerListeners();
  }
  return o(n2, [{ key: "registerListeners", value: function() {
    var n3 = this;
    window.addEventListener("message", function(e2) {
      var t2 = "".concat(e2.origin, "/") === m.checkoutUrl, a2 = n3.checkoutIframe && n3.checkoutIframe.contentWindow === e2.source, i2 = n3.isEmbed;
    ...
    return new Promise(function(n4, t2) {
      e2.requestInline().then(function(t3) {
        var a2 = function() {
          var n5 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e3 = n5.platform, t4 = n5.userAgent, a3 = void 0 === t4 ? window && window.navigator && window.navigator.userAgent : t4, i3 = e3 || X, o2 = a3 && !!a3.match(/Version\/[\d.]+.*Safari/), r2 = i3 && /(Mac)/i.test(i3);
          return $() || r2 && o2;
        }() && T(t3.channels), i2 = function() {
          var n5 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e3 = !!n5.custom_filters && n5.custom_filters.recurring, t4 = n5.plan_details, a3 = e3 || t4, i3 = !!n5.link_config && n5.link_config.enabled && n5.link_config.has_payment_instruments;
          return !a3 && i3;
        }(t3);
        i2 || a2 ? (ln.preloadTransaction({ inlineTransaction: e2, transactionData: t3 }), ln.preCheckoutModal = function(n5, e3) {
          ...
          i3.classList.add("pre-checkout-modal"), i3.id = "pre-checkout-modal-".concat(n5), i3.style.zIndex = q() + 1;
          var o2 = document.createElement("div");
          ...
          C2.classList.add("payment-info"), C2.innerHTML = '<img class="merchant-logo" src="'.concat(c2, '" alt="').concat(s2, ' Logo">\n    <div class="customer-info">\n      <div class="customer-email">').concat(d2 || l2, '</div>\n      <div class="transaction-amount">Pay <span class="amount">').concat(h2, "</span></div>\n    </div>"), o2.appendChild(C2), o2.innerHTML += w;
          var m2 = document.createElement("div");
          m2.classList.add("modal-wrapper"), t4.canPayWithVault ? J(m2, { canPayWithApplePay: t4.canPayWithApplePay }) : K(m2), m2.innerHTML = m2.innerHTML + b + k, o2.appendChild(m2);
          var y2 = document.createElement("style");
          return y2.textContent = P, document.body.appendChild(y2), document.body.appendChild(i3), i3;
        }(ln.id, t3, { canPayWithVault: i2, canPayWithApplePay: a2 }), a2 ? (ln.paymentRequestContainer = D(ln.preCheckoutModal), O(ln.paymentRequestContainer, { channels: t3.channels, styles: { applePay: { width: "100%", type: "pay", height: "42px", padding: "15px", borderRadius: "5px" } } }, t3.merchant_id).then(function() {
          ln.registerPaymentRequestEventListeners();
        }).catch(function() {
          i2 ? D(ln.preCheckoutModal).remove() : (ln.closePreCheckoutModal(), ln.animateCheckoutIn());
        }).finally(function() {
          n4(e2);
        })) : n4(e2)) : (ln.newTransaction({ inlineTransaction: e2, transactionData: t3 }), n4(e2));
      }).catch(function(n5) {
    ...
    var i2 = R(this.preCheckoutModal), o2 = this.preCheckoutModal.querySelector("#".concat(Z));
    i2.onclick = function() {
    ...
    var e2 = n3.preload, t2 = n3.inlineTransaction, a2 = n3.transactionData, i2 = c(n3, pn), o2 = this.paymentRequestContainer && I(this.paymentRequestContainer);
    if (this.activeTransaction() && !o2 && this.activeTransaction().cancel(), t2 && a2) return this.transactions.push(t2), this.isDeprecatedApi || this.open({ accessCode: a2.access_code }, e2), t2;
    var r2 = dn(this.transactions, t2 ? t2.parameters : i2);
    if (r2) return r2.isActive = true, this.isDeprecatedApi || this.open({ accessCode: r2.accessCode }, e2), r2;
    var s2 = t2 || new rn(i2), l2 = s2.accessCode ? { accessCode: s2.accessCode } : s2.urlParameters;
    ...
    var e2 = n3.container, t2 = n3.styles, a2 = n3.onElementsMount, i2 = c(n3, un);
    return ln = this, new Promise(function(o2, r2) {
      ...
      if (A()) {
        ...
        var s2 = dn(ln.transactions, i2), l2 = s2 || new rn(i2);
        l2.requestInline().then(function(n4) {
          O(ln.paymentRequestContainer, { channels: n4.channels, styles: t2 }, n4.merchant_id).then(function(n5) {
            ...
            if (s2 ? l2.isActive = true : ln.transactions.push(l2), ln.registerPaymentRequestEventListeners(), c2) {
              var e3 = ln.preloadTransaction({ inlineTransaction: l2, transactionData: n4 });
              c2.onclick = e3;
            }
            o2(l2);
          });
        ...
        if (n3 && n3.loadPaystackCheckoutButton) if (c2) {
          var p2 = ln.preloadTransaction(i2);
          c2.onclick = p2;
    ...
    var n3, t2, a2, i2, o2, r2 = this, c2 = "apple pay", s2 = this.activeTransaction();
    if (s2) {
      ...
      try {
        ...
        var u2 = (n3 = { currency: s2.response.currency, amount: s2.response.amount, merchantName: s2.response.merchant_name, interval: s2.response.plan_details && s2.response.plan_details.interval }, t2 = n3.currency, a2 = n3.amount, i2 = n3.merchantName, o2 = n3.interval, e({ countryCode: "NG", currencyCode: t2, merchantCapabilities: ["supports3DS", "supportsCredit", "supportsDebit"], supportedNetworks: ["visa", "masterCard"], requiredBillingContactFields: ["postalAddress", "name", "phone", "email"], total: { label: "".concat(i2, " - Paystack"), type: "final", amount: String(_(a2)) } }, "string" == typeof o2 && "" !== o2.trim() && { lineItems: [{ label: E(o2), amount: String(_(a2)) }] })), d2 = new window.ApplePaySession(m.applePayVersion, u2);
        d2.onvalidatemerchant = function(n4) {
          var t3 = function(n5) {
            var t4 = n5.transactionId, a3 = n5.validationURL, i3 = n5.merchantName, o3 = n5.domainName, r3 = void 0 === o3 ? window && window.location && window.location.hostname : o3, c3 = "".concat(m.paymentBaseUrl).concat(m.applePayValidateSessionPath), s3 = S({ transaction: t4, sessionUrl: a3, displayName: i3, domainName: r3 });
          ...
          var t3 = n4.payment, a3 = function(n5) {
            var t4 = n5.transactionId, a4 = n5.payment, i3 = "".concat(m.paymentBaseUrl).concat(m.applePayChargePath), o3 = S({ transaction: t4, paymentObject: JSON.stringify(a4) });
            return fetch(i3, e(e({}, L), {}, { body: o3 })).then(function(n6) {
              return n6.json();
            });
        ...
        if (o2) switch (o2) {
          case "loaded:checkout":
            if (this.isLoaded = true, a2) {
              ...
              hn({ checkoutIframe: c2, urlParameters: l2 ? { accessCode: l2.access_code } : s2 });
            }
            break;
    ...
    var a2 = ln.newTransaction(e2, "deprecated"), i2 = a2.urlParameters;
    if (t2) {
      var o2 = "".concat(m.siteUrl, "/assets/payment/production/inline.html?").concat(y(i2)), r2 = function(n3, e3) {
      ...
      sn("openIframe", "open", "Please consult our documentation at https://developers.paystack.co/docs/paystack-inline"), ln.open(i2);
    };
    return a2;
  } }]), n2;
}();
if (gn = g().length > 0, bn = f() && "FORM" === f().parentElement.tagName, gn && bn) {
  xn = function() {
    ...
    return g().forEach(function(e2) {
      var a2 = t2.getAttribute(e2), i2 = e2.split("data-")[1].replace(/-([a-z])/g, function(n3) {
  ...
  ln || (ln = new kn()), function(n2) {
    ...
    n2.preventDefault(), wn ? ln.resumeTransaction(wn.accessCode) : wn = ln.newTransaction(e(e({}, xn), {}, { onSuccess: function(n3) {
      ...
      e2 = { type: "hidden", name: "reference", value: n3.reference, parent: Mn }, t2 = e2.type, a2 = e2.value, i2 = e2.name, o2 = e2.parent, (r2 = document.createElement("input")).type = t2, r2.value = a2, r2.name = i2, o2.appendChild(r2), Mn.submit();
    } }));
  });
}
var wn;
